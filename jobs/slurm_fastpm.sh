#!/bin/bash
#SBATCH --job-name=nicolas  # Job name
...
nbody=quijotelike_for_nicolas
sim=fastpm
multisnapshot=False
extras="nbody.matchIC=2 nbody.postprocess=False" #  meta.cosmofile=./params/abacus_cosmologies.txt"
L=1000
N=128
