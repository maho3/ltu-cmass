...
rm_galaxies=True
extras="bias=zheng_biased diag.focus_z=0.5 nbody.zf=0.5" #  meta.cosmofile=./params/abacus_custom_cosmologies.txt" #  bias=zheng_biased 
extras="$extras noise.params.radial=4 noise.params.transverse=4"
L=2000
N=256
