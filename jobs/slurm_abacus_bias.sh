...
nbody=abacuslike
sim=fastpm_hodzbias_constrained
multisnapshot=True
diag_from_scratch=False
rm_galaxies=False
extras="bias=zheng_biased bias.hod.custom_prior=mtng diag.high_res=True diag.focus_z=0.5" #  meta.cosmofile=./params/abacus_custom_cosmologies.txt" #  bias=zheng_biased 
L=2000
N=256
