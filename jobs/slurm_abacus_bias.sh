...
rm_galaxies=False
extras="" # meta.cosmofile=./params/abacus_cosmologies.txt" # "bias=zdep" # # "nbody.zf=0.500015"
L=2000
N=256
    ...
    for i in $(seq 0 $(($Nhod-1))); do
        ...
        for aug_seed in $(seq 0 $(($Naug-1))); do
            ...
            if [ -f $file ]; then
                ...
                echo "File $file does not exist."
                python -m cmass.survey.simbig_selection $postfix bias.hod.seed=$hod_seed survey.aug_seed=$aug_seed
            fi
